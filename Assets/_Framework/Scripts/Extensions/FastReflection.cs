    ...
    public static class FastReflection
    {
        ...
        public static void GenDebugAssembly<TTarget>(string name, FieldInfo field, PropertyInfo property, MethodInfo method, Type targetType, Type[] ctorParamTypes)
        {
            ...
            if (field != null)
            {
                ...
                emit.il = buildMethod("FieldSetter", typeof(void), new[] { typeof(TTarget).MakeByRefType(), fieldType });
                GenFieldSetter<TTarget>(field);
                emit.il = buildMethod("FieldGetter", fieldType, new[] { typeof(TTarget) });
            ...
            if (property != null)
            {
                ...
                emit.il = buildMethod("PropertySetter", typeof(void), new[] { typeof(TTarget).MakeByRefType(), propType });
                GenPropertySetter<TTarget>(property);
                emit.il = buildMethod("PropertyGetter", propType, new[] { typeof(TTarget) });
            ...
            if (method != null)
            {
                ...
                emit.il = buildMethod("MethodCaller", returnType, new[] { typeof(TTarget), typeof(object[]) });
                GenMethodInvocation<TTarget>(method);
            }

            if (targetType != null)
            {
                emit.il = buildMethod("Ctor", typeof(TTarget), new[] { typeof(object[]) });
